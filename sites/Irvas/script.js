...
const forms = state => {
  ...
  forms.forEach(form => {
    form.addEventListener('submit', e => {
      ...
      }).catch(() => messageStatus.textContent = message.failure).finally(() => {
        clearInputs();
        setTimeout(() => {
...
const modals = () => {
  ...
  bindModal('.phone_link', '.popup_engineer', '.popup .popup_close');
  bindModal('.popup_calc_btn', '.popup_calc', '.popup_calc_close');
  bindModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false);
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); //showModalByTime('.popup_engineer', 10000);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const tabs = (headerSelector, tabSelector, activeClass, contentSelector, display = 'block') => {
